...
while True:
    ...
    # Bundle adjustment
    res = flight.BA(cam_temp,rs_crt=rs)
...
with open('data2/cvpr_res/fixposition/trajectory/flight_cam_{}_rs_{}.pkl'.format(cam_model,rs),'wb') as f:
